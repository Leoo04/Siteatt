...
function validaEncomenda(encomenda){
    ...
    if(encomenda.unitario <=0 || isNaN(encomenda.unitario)){
     ...
     // Se houver erros, exibe um alerta com a lista de erros
     if (erros.length > 0) {
        var mensagemErro = "Por favor, corrija os seguintes erros:\n\n";
...
var encomenda = {
    nome: "Produto",
    qtde: 0, // Substitua pelos valores que você deseja validar
    unitario: "xyz" // Substitua pelos valores que você deseja validar
};
